...
import { getAllProducts, updateProduct } from "../api/task.api"
...
export function EditProductForm() {
  ...
  useEffect(() => {
    async function loadTasks() {
      ...
      const producto = products.find((product: Product) => product.id == id)
      setProduct(producto);      
    }
        ...
        <form onSubmit={onSubmit}>
          <div className="grid gap-4">
            <div className="grid gap-1">
              ...
              <Input {...register("nombre")} id="nombre" placeholder={product?.nombre} required />
